...
fruitProcessor(5, 2); / / / //the actual value of the parameters are called arguments.
...
const interestedIn = prompt('What do you want to know about sohom? Choose between firstName, lastName, age, job and friends');
...
console.log(`${sohom.firstName} has ${sohom.friends.length} friends, and his best friend is called ${sohom.friends[0]}`)